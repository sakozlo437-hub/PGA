...
The code can automatically create all required tables and fields for you!
...
2. **Create Empty Database**: 
   ...
   - **Don't create any tables manually!**
...
5. **Run Auto-Setup Script**:
   ...
   **Or via GitHub Actions** (will run automatically on first workflow execution)

6. **Verify**: Check your Baserow dashboard - you should see 7 tables created:
   - keywords
   - trends
   - pins
   - engagement
...
If you prefer to create tables manually, follow these specifications:
